...
from dqn_agent import IQDqnAgent
...
args.experiment = 'iqndqn_8atoms_128quantile_s256x128_bs2048_adam2e6_per_normal_nonstep'
args.load = True
args.train = False
...
dqn = IQDqnAgent( args.state_dim, args.action_dim, args.buffer_size, args.batch_size, args.experiment, 256, 128, 8, 128, priorized_exp = True, gn = False )
